...
Compute eqb_string "x" "x".
Compute eqb_string "x" "y".
...
Notation "A :: B" := (list A B) (at level 60, right associativity).

Check list Nat 7 (list Nat 8 []).
Check list Bool true (list Bool false []).

Definition list123 := [1 >n 2 >n 3].
Compute list123.

Definition listTFF := [true >b false >b false].
Compute listTFF.

Definition liststring := (string :: "L") ((string :: "T") [ ]).
Compute liststring.
...
Check NatArray list123.

Notation "'NA' L" := (NatArray L) (at level 10).
Definition array456 := NA [4 >n 5 >n 6].
Compute array456.

Notation "'BA' L" := (BoolArray L) (at level 10).
Definition arrayFTT := BA [false >b true >b true].
Compute arrayFTT.

Notation "'MA' L" := (MultipleArray L) (at level 10).
Definition matrixNatBool := MA [array456 >a arrayFTT].
Compute matrixNatBool.
...
Definition initial_environment : environment := fun n => Undeclared. 
...
| declareAndAssign: string -> string -> Exp -> Statement
| declareFixedArray: string -> nat -> Statement
| declareDynamicArray: string -> Statement
| forloop: statement -> Exp -> 
