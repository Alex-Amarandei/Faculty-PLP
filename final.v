...
| declareVar: string -> string -> Statement
| assignVar: string -> ResultTypes -> Statement
| initializeVar: string -> string -> ResultTypes -> Statement
| initializeStruct: string -> List Field -> Statement
| getFieldValue: string -> string -> Statement
| setFieldValue: 
...
| declareArray: string -> string -> Statement
| initializeArray: string -> string -> List ResultTypes -> Statement
